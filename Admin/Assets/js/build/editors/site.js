    ...
    */
    ...
    const DefaultLangIcon = () => /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Icon, {
        ...
        children: (0,external_this_wp_i18n_.__)('Default language.', 'linguator-multilingual-ai-translation')
      })]
    });
    ...
    const TEMPLATE_PART_SLUG_SEPARATOR = '___'; // Its value must be synchronized with its equivalent in PHP @see LMAT_FSE_Template_Slug::SEPARATOR.
    const TEMPLATE_PART_SLUG_CHECK_LANGUAGE_PATTERN = '[a-z][a-z0-9_-]*'; // Its value must be synchronized with it equivalent in PHP @see LMAT_FSE_Template_Slug::SEPARATOR.
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("p", {
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
            ...
            children: (_ref = 'wp_template_part' === postType?.slug) !== null && _ref !== void 0 ? _ref : (0,external_this_wp_i18n_.__)('This template part is used for languages that have not yet been translated.', 'linguator-multilingual-ai-translation')
          })
        })]
      });
    };
    ...
    const DeleteButton = ({
      ...
      // translators: %s is a native language name.
      (0,external_this_wp_i18n_.__)('Delete the translation in %s', 'linguator-multilingual-ai-translation'), language.name);
      return /*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
        icon: library_trash,
    ...
    const machine_translation_MachineTranslationButton = props => {
      ...
      const newProps = {
        ...
        __('Deactivate %s machine translation', 'linguator-multilingual-ai-translation'), props.name),
        inactiveLabel: sprintf(/* translators: %s is the name of the machine translation service. */
        __('Activate %s machine translation', 'linguator-multilingual-ai-translation'), props.name),
        icon: iconElement
      };
    ...
    const duplicate_DuplicateButton = props => {
      const newProps = {
        ...
        activeLabel: __('Deactivate the content duplication', 'linguator-multilingual-ai-translation'),
        /* translators: accessibility text */
        inactiveLabel: __('Activate the content duplication', 'linguator-multilingual-ai-translation'),
    ...
    class synchronization_SynchronizationButton extends external_this_wp_element_.Component {
      ...
      static handleSynchronizationChange(language) {
        const syncPost = (0,external_this_wp_data_.select)(settings_MODULE_CORE_EDITOR_KEY).getEditedPostAttribute('lmat_sync_post');
        ...
        (0,external_this_wp_data_.dispatch)(settings_MODULE_CORE_EDITOR_KEY).editPost({
          lmat_sync_post: utils_convertMapToObject(synchronizedPosts)
        });
    ...
    synchronization_SynchronizationButton.labelConfirmationModal = (0,external_this_wp_i18n_.__)('Synchronize this post', 'linguator-multilingual-ai-translation');
    ...
    const SynchronizationButtonWithConfirmation = confirmation_modal('lmat_sync_post', ModalContent, synchronization_SynchronizationButton.handleSynchronizationChange)(synchronization_SynchronizationButton);
    ...
    const DeleteModalBody = ({
      ...
      const defaultLangText = () => {
        ...
        return /*#__PURE__*/(0,jsx_runtime.jsxs)("p", {
          children: [(0,external_this_wp_i18n_.__)('You are about to delete an entity in the default language.', 'linguator-multilingual-ai-translation'), /*#__PURE__*/(0,jsx_runtime.jsx)("br", {}), (0,external_this_wp_i18n_.__)('This will delete its customizations and all its corresponding translations.', 'linguator-multilingual-ai-translation')]
        });
      };
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [defaultLangText(), /*#__PURE__*/(0,jsx_runtime.jsx)("p", {
          children: (0,external_this_wp_i18n_.__)('Are you sure you want to delete this translation?', 'linguator-multilingual-ai-translation')
        })]
      });
    };
    ...
    const useDeletePost = () => {
      ...
      const handleDelete = async (postId, postType) => {
        try {
          ...
          createSuccessNotice((0,external_this_wp_i18n_.__)('The translation has been deleted.', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
        } catch (error) {
          ...
          (0,external_this_wp_i18n_.__)('Unable to delete the translation. %s', 'linguator-multilingual-ai-translation'), error?.message), {
            type: 'snackbar'
          });
        }
      };
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(buttons_delete, {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(delete_modal_body, {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
              ...
              type: "submit",
              children: (0,external_this_wp_i18n_.__)('Delete', 'linguator-multilingual-ai-translation')
            })]
          })]
        })]
      });
    ...
    const useCreateTranslation = () => {
      ...
      const handleCreateTranslation = async (language, post) => {
        ...
        try {
          ...
          createSuccessNotice((0,external_this_wp_i18n_.__)('The translation is created, you will be redirected.', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
          ...
          const errorMessage = error.message && error.code !== 'unknown_error' ? error.message : (0,external_this_wp_i18n_.__)('An error occurred while creating the translation.', 'linguator-multilingual-ai-translation');
    ...
    const utils_getNewTranslationsDataMap = newLanguage => {
      ...
      const syncPost = select(MODULE_CORE_EDITOR_KEY).getEditedPostAttribute('lmat_sync_post');
    ...
    const switcher_Switcher = ({
      ...
      const confirmChange = () => {
        closeModal();
        if (!selectedLang) {
          createErrorNotice(__('Failed to save selected language', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
          return;
        }
        ...
        saveLanguageChange(selectedLang, newTranslationsData).then(() => {
          ...
          createSuccessNotice(__('Language changed', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
      ...
      return /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsx("p", {
          ...
          children: [/*#__PURE__*/_jsx("p", {
            children: __('Are you sure you want to change the language of the current content?', 'linguator-multilingual-ai-translation')
          }), /*#__PURE__*/_jsxs("div", {
            role: "group",
            className: "components-button-group buttons",
            children: [/*#__PURE__*/_jsx(Button, {
              ...
              type: "submit",
              children: __('Change', 'linguator-multilingual-ai-translation')
            })]
          })]
        })]
      });
