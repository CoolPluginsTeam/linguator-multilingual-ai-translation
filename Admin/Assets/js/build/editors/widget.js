...
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const addLangChoiceAttribute = function (settings, name) {
      ...
      settings.attributes = (0,external_lodash_.assign)(settings.attributes, {
        lmat_lang: LanguageAttribute
      });
      return settings;
    };
    (0,external_this_wp_hooks_.addFilter)('blocks.registerBlockType', 'lmat/lang-choice', addLangChoiceAttribute);
    const withInspectorControls = (0,external_this_wp_compose_.createHigherOrderComponent)(BlockEdit => {
      return props => {
        ...
        const isLanguageFilterable = !(0,external_lodash_.isNil)(lmat_lang);
        const selectedLanguage = languages.get(lmat_lang);
        return /*#__PURE__*/(0,jsx_runtime.jsxs)(external_this_wp_element_.Fragment, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(BlockEdit, {
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)(external_this_wp_components_.PanelBody, {
              title: (0,external_this_wp_i18n_.__)('Languages', 'linguator-multilingual-ai-translation'),
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)("label", {
                htmlFor: "lmat_post_lang_choice",
                children: (0,external_this_wp_i18n_.__)('The block is displayed for:', 'linguator-multilingual-ai-translation')
    ...
    isLanguagesinitialized().then(function () {
      (0,external_this_wp_hooks_.addFilter)('editor.BlockEdit', 'lmat/lang-choice-with-inspector-controls', withInspectorControls);
    });
     ...
     */
    function (options) {
      if ('undefined' !== typeof lmat_block_editor_plugin_settings) {
        addLanguageToRequest(options, lmat_block_editor_plugin_settings.lang.slug);
      }
      return options;
    });
    })();
