...
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
    ...
    */
    ...
    const Sidebar = ({
      ...
      const title = (0,external_this_wp_i18n_.__)('Languages', 'linguator-multilingual-ai-translation');
    ...
    function language_flag_LanguageFlag({
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
        className: "lmat-translation-icon",
     ...
     * @param {Object}          props.selectedLanguage An object representing a Linguator Language. Default to null.
    ...
    function LanguageDropdown({
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(language_flag, {
          ...
          id: "lmat_post_lang_choice",
          name: "lmat_post_lang_choice",
    ...
    const settings_MODULE_KEY = 'lmat/metabox';
    ...
    const settings_TEMPLATE_PART_SLUG_SEPARATOR = '___'; // Its value must be synchronized with its equivalent in PHP @see LMAT_FSE_Template_Slug::SEPARATOR.
    const settings_TEMPLATE_PART_SLUG_CHECK_LANGUAGE_PATTERN = '[a-z][a-z0-9_-]*'; // Its value must be synchronized with it equivalent in PHP @see LMAT_FSE_Template_Slug::SEPARATOR.
      ...
      return /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsx("p", {
          children: /*#__PURE__*/_jsx("strong", {
            children: __('Language', 'linguator-multilingual-ai-translation')
          })
        }), /*#__PURE__*/_jsxs("div", {
          className: "lmat-language-item",
          children: [/*#__PURE__*/_jsx(LanguageFlag, {
            language: language
          }), /*#__PURE__*/_jsx("span", {
            className: "lmat-language-name",
            children: language.name
          }), language.is_default && /*#__PURE__*/_jsx(DefaultLangIcon, {})]
        }), language.is_default && /*#__PURE__*/_jsx("div", {
          children: /*#__PURE__*/_jsx("span", {
            className: "lmat-metabox-info",
            children: (_ref = 'wp_template_part' === postType?.slug) !== null && _ref !== void 0 ? _ref : __('This template part is used for languages that have not yet been translated.', 'linguator-multilingual-ai-translation')
          })
        })]
      });
    };
    ...
    const MetaboxWrapper = ({
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "lmat-metabox-location",
          children: children
        })
      });
    };
    ...
    const NotTranslatableNotice = ({
      ...
      if ('wp_template' === postType) {
        return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "lmat-metabox-error components-notice is-warning",
          children: (0,external_this_wp_i18n_.__)('Templates are not translatable, only template parts are.', 'linguator-multilingual-ai-translation')
        });
      }
      return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "lmat-metabox-error components-notice is-warning",
        children: (0,external_this_wp_i18n_.__)('This entity is not translatable.', 'linguator-multilingual-ai-translation')
      });
    };
      ...
      if (isError) {
        return /*#__PURE__*/(0,jsx_runtime.jsx)(wrapper, {
          children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            ...
            children: (0,external_this_wp_i18n_.__)('Unable to retrieve the content language', 'linguator-multilingual-ai-translation')
          })
        });
      }
      return /*#__PURE__*/(0,jsx_runtime.jsx)(wrapper, {
    ...
    const add_or_edit_AddOrEditCell = ({
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)("td", {
        className: "lmat-edit-column lmat-column-icon",
        children: children
      });
    };
    ...
    const default_language_DefaultLanguageCell = ({
      ...
      return /*#__PURE__*/_jsx("td", {
        className: "lmat-default-lang-column lmat-column-icon",
    ...
    const delete_DeleteCell = ({
      ...
      return /*#__PURE__*/_jsx("td", {
        className: "lmat-delete-column lmat-column-icon",
        children: children
      });
    };
    ...
    const SynchronizationCell = ({
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)("td", {
        className: "lmat-sync-column lmat-column-icon",
        children: children
      });
    };
    ...
    const translation_input_TranslationInputCell = ({
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)("td", {
        className: "lmat-translation-column",
        children: children
      });
    };
    ...
    const add_AddButton = ({
      ...
      (0,external_this_wp_i18n_.__)('Add a translation in %s', 'linguator-multilingual-ai-translation'), language.name);
      return /*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
        href: href,
        icon: library_plus,
        label: accessibilityText,
        className: `lmat-button`,
    ...
    const delete_DeleteButton = ({
      ...
      // translators: %s is a native language name.
      __('Delete the translation in %s', 'linguator-multilingual-ai-translation'), language.name);
    ...
    const PersistingUserDataButton = ({
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
        id: id,
        className: `lmat-button lmat-before-post-translations-button ${isActive && `wp-ui-text-highlight`}`,
    ...
    const MachineTranslationButton = props => {
      ...
      const newProps = {
        ...props,
        id: 'lmat-machine-translation',
        userPreferenceName: `lmat_machine_translation_${props.slug}`,
        activeLabel: (0,external_this_wp_i18n_.sprintf)(/* translators: %s is the name of the machine translation service. */
        (0,external_this_wp_i18n_.__)('Deactivate %s machine translation', 'linguator-multilingual-ai-translation'), props.name),
        inactiveLabel: (0,external_this_wp_i18n_.sprintf)(/* translators: %s is the name of the machine translation service. */
        (0,external_this_wp_i18n_.__)('Activate %s machine translation', 'linguator-multilingual-ai-translation'), props.name),
        icon: iconElement
      };
    ...
    const DuplicateButton = props => {
      const newProps = {
        ...props,
        id: 'lmat-duplicate',
        userPreferenceName: 'lmat_duplicate_content',
        /* translators: accessibility text */
        activeLabel: (0,external_this_wp_i18n_.__)('Deactivate the content duplication', 'linguator-multilingual-ai-translation'),
        /* translators: accessibility text */
        inactiveLabel: (0,external_this_wp_i18n_.__)('Activate the content duplication', 'linguator-multilingual-ai-translation'),
    ...
    const edit_EditButton = ({
      ...
      (0,external_this_wp_i18n_.__)('Edit the translation in %s', 'linguator-multilingual-ai-translation'), language.name);
      return /*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
        href: href,
        icon: library_pencil,
        label: accessibilityText,
    ...
    const isBlockPostEditorContextInitialized = () => {
      if ((0,external_lodash_.isNil)((0,external_this_wp_data_.select)(MODULE_CORE_EDITOR_KEY))) {
        return Promise.reject("Linguator languages panel can't be initialized because block editor isn't fully initialized.");
      }
    ...
    function getCurrentLanguageSlug() {
      if ((0,external_lodash_.isUndefined)((0,external_this_wp_data_.select)(MODULE_CORE_EDITOR_KEY))) {
        ...
        return lmat_block_editor_plugin_settings.lang.slug;
      }
      ...
      // and update lmat_block_editor_plugin_settings at the same time.
      const params = new URL(document.location).searchParams;
      const postType = params.get('postType');
      const postId = params.get('postId');
      if ('wp_template_part' === postType && (0,external_lodash_.isNil)(postId)) {
        lmat_block_editor_plugin_settings.lang = getDefaultLanguage();
        return lmat_block_editor_plugin_settings.lang.slug;
      }
        ...
        return /*#__PURE__*/(0,jsx_runtime.jsxs)(external_this_wp_components_.Modal, {
          ...
          children: [children, /*#__PURE__*/(0,jsx_runtime.jsxs)(external_this_wp_components_.ButtonGroup, {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
              ...
              children: (0,external_this_wp_i18n_.__)('OK', 'linguator-multilingual-ai-translation')
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
              id: `${idPrefix}_cancel`,
              isSecondary: true,
              onClick: () => updateState(),
              children: (0,external_this_wp_i18n_.__)('Cancel', 'linguator-multilingual-ai-translation')
            })]
          })]
        });
      }
     ...
     * @param {Object} [translationData] A entry which represents the translation of the current post in a language {@see LMAT_REST_Post::get_translations_table()}.
     */
    ...
    class SynchronizationButton extends external_this_wp_element_.Component {
      ...
      static handleSynchronizationChange(language) {
        const syncPost = (0,external_this_wp_data_.select)(MODULE_CORE_EDITOR_KEY).getEditedPostAttribute('lmat_sync_post');
        ...
        (0,external_this_wp_data_.dispatch)(MODULE_CORE_EDITOR_KEY).editPost({
          lmat_sync_post: convertMapToObject(synchronizedPosts)
        });
      ...
      render() {
        ...
        const synchronizeButtonText = isSynchronized ? (0,external_this_wp_i18n_.__)("Don't synchronize this post", 'linguator-multilingual-ai-translation') : (0,external_this_wp_i18n_.__)('Synchronize this post', 'linguator-multilingual-ai-translation');
        return /*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
          icon: library_synchronization,
          label: synchronizeButtonText,
          id: `lmat_sync_post[${translationData.lang.slug}]`,
          className: `lmat-button ${highlightButtonClass}`,
          onClick: event => {
    ...
    SynchronizationButton.labelConfirmationModal = (0,external_this_wp_i18n_.__)('Synchronize this post', 'linguator-multilingual-ai-translation');
    const ModalContent = function () {
      return /*#__PURE__*/(0,jsx_runtime.jsx)("p", {
        children: (0,external_this_wp_i18n_.__)('You are about to overwrite an existing translation. Are you sure you want to proceed?', 'linguator-multilingual-ai-translation')
      });
    };
    const SynchronizationButtonWithConfirmation = confirmation_modal('lmat_sync_post', ModalContent, SynchronizationButton.handleSynchronizationChange)(SynchronizationButton);
    ...
    class TranslationInput extends external_this_wp_element_.Component {
      ...
      updateSuggestions(value, noControl = false) {
        ...
        const request = external_this_wp_apiFetch_default()({
          path: (0,external_this_wp_url_.addQueryArgs)('/lmat/v1/untranslated-posts', {
            search: value,
            include: postId,
        ...
        request.then(posts => {
          ...
          if (!!posts.length) {
            ...
            (0,external_this_wp_i18n_._n)('%d result found, use up and down arrow keys to navigate.', '%d results found, use up and down arrow keys to navigate.', posts.length, 'linguator-multilingual-ai-translation'), posts.length), 'assertive');
          } else {
            /* translators: accessibility text */
            this.props.debouncedSpeak((0,external_this_wp_i18n_.__)('No results.', 'linguator-multilingual-ai-translation'), 'assertive');
          }
        }).catch(() => {
          if (this.suggestionsRequest === request) {
            this.setState({
      ...
      render() {
        ...
        return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("label", {
            ...
            children: /* translators: accessibility text */(0,external_this_wp_i18n_.__)('Translation', 'linguator-multilingual-ai-translation')
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("input", {
              ...
              type: "text",
              "aria-label": /* translators: accessibility text */(0,external_this_wp_i18n_.__)('URL', 'linguator-multilingual-ai-translation'),
              required: true,
              value: value,
              onChange: this.onChange,
              onInput: stopEventPropagation,
              placeholder: (0,external_this_wp_i18n_.__)('Start typing the post title', 'linguator-multilingual-ai-translation'),
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: posts.map((post, index) => /*#__PURE__*/(0,jsx_runtime.jsx)("button", {
                ...
                children: post.title.raw || (0,external_this_wp_i18n_.__)('(no title)', 'linguator-multilingual-ai-translation')
              }, post.id))
            })
          })]
        });
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("p", {
          children: /*#__PURE__*/(0,jsx_runtime.jsx)("strong", {
            children: (0,external_this_wp_i18n_.__)('Translations', 'linguator-multilingual-ai-translation')
          })
    ...
    const delete_modal_body_DeleteModalBody = ({
      ...
      const defaultLangText = () => {
        ...
        return /*#__PURE__*/_jsxs("p", {
          children: [__('You are about to delete an entity in the default language.', 'linguator-multilingual-ai-translation'), /*#__PURE__*/_jsx("br", {}), __('This will delete its customizations and all its corresponding translations.', 'linguator-multilingual-ai-translation')]
        });
      };
      return /*#__PURE__*/_jsxs(_Fragment, {
        children: [defaultLangText(), /*#__PURE__*/_jsx("p", {
          children: __('Are you sure you want to delete this translation?', 'linguator-multilingual-ai-translation')
        })]
      });
    };
    ...
    const use_delete_post_useDeletePost = () => {
      ...
      const handleDelete = async (postId, postType) => {
        try {
          ...
          createSuccessNotice(__('The translation has been deleted.', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
        } catch (error) {
          createErrorNotice(sprintf(/* translators: %s: Error message describing why the post could not be deleted. */
          __('Unable to delete the translation. %s', 'linguator-multilingual-ai-translation'), error?.message), {
            type: 'snackbar'
          });
        }
      };
        ...
        children: [/*#__PURE__*/_jsx(DeleteButton, {
          ...
          children: [/*#__PURE__*/_jsx(DeleteModalBody, {
            ...
            children: [/*#__PURE__*/_jsx(Button, {
              ...
              onClick: closeModal,
              type: "button",
              children: __('Cancel', 'linguator-multilingual-ai-translation')
            }), /*#__PURE__*/_jsx("span", {
              children: "\xA0"
              ...
              type: "submit",
              children: __('Delete', 'linguator-multilingual-ai-translation')
            })]
          })]
        })]
      });
    ...
    const use_create_translation_useCreateTranslation = () => {
      ...
      const handleCreateTranslation = async (language, post) => {
        ...
        try {
          ...
          createSuccessNotice(__('The translation is created, you will be redirected.', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
          ...
          const errorMessage = error.message && error.code !== 'unknown_error' ? error.message : __('An error occurred while creating the translation.', 'linguator-multilingual-ai-translation');
        ...
        return /*#__PURE__*/_jsx("tr", {
          children: /*#__PURE__*/_jsxs(TranslationRow, {
            ...
            children: [/*#__PURE__*/_jsx(TranslationInputCell, {
              children: /*#__PURE__*/_jsx("span", {
                className: "lmat-translation-language",
    ...
    const SiteEditorMetabox = () => {
      ...
      const language = getSelectedLanguage(postLang);
      ...
      const table = getTranslationsTable(translationsTableData || {});
    ...
    const getNewTranslationsDataMap = newLanguage => {
      ...
      lmat_block_editor_plugin_settings.lang = newLanguage;
      return {
    ...
    const Switcher = ({
      ...
      const confirmChange = () => {
        closeModal();
        if (!selectedLang) {
          createErrorNotice((0,external_this_wp_i18n_.__)('Failed to save selected language', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
          return;
        }
        ...
        saveLanguageChange(selectedLang, newTranslationsData).then(() => {
          ...
          createSuccessNotice((0,external_this_wp_i18n_.__)('Language changed', 'linguator-multilingual-ai-translation'), {
            type: 'snackbar'
          });
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("p", {
          children: /*#__PURE__*/(0,jsx_runtime.jsx)("strong", {
            children: (0,external_this_wp_i18n_.__)('Language', 'linguator-multilingual-ai-translation')
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("label", {
          className: "screen-reader-text",
          htmlFor: "lmat_post_lang_choice",
          children: (0,external_this_wp_i18n_.__)('Language', 'linguator-multilingual-ai-translation')
          ...
          title: (0,external_this_wp_i18n_.__)('Change language', 'linguator-multilingual-ai-translation'),
          onRequestClose: abortChange,
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("p", {
            children: (0,external_this_wp_i18n_.__)('Are you sure you want to change the language of the current content?', 'linguator-multilingual-ai-translation')
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            role: "group",
            className: "components-button-group buttons",
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(external_this_wp_components_.Button, {
              ...
              type: "submit",
              children: (0,external_this_wp_i18n_.__)('Change', 'linguator-multilingual-ai-translation')
            })]
          })]
        })]
      });
    ...
    const PostEditorMetabox = () => {
      ...
      const language = utils_getSelectedLanguage(finalLang);
      ...
      if (!lang && finalLang && language) {
        ...
        try {
          ...
          console.log('Could not assign language:', error);
        }
      }
      ...
      const table = utils_getTranslationsTable(finalTranslationsData || {}, finalLang);
      ...
      const machineTranslation = lmat_block_editor_plugin_settings?.machine_translation;
     ...
     * Ensures that `lmatFilteredRoutes` has been well defined on server side and
    ...
    const editorsRequestsFilter = filterCallback => {
      external_this_wp_apiFetch_default().use((options, next) => {
        ...
        return next(filter_path(options, lmatFilteredRoutes, filterCallback));
      });
    };
  ...
  const sidebarName = 'linguator-sidebar';
    const settingsErrors = lmat_block_editor_plugin_settings?.machine_translation?.errors; // eslint-disable-line no-undef, camelcase
