...
class Term extends Abstract_Object {
	/**
	 * Returns the language to set for a term creation.
	 *
	 * @since 0.0.8
	 *
	 ...
	 * @return LMAT_Language The language context.
	 */
	public function get_language( User $user, int $id = 0, string $taxonomy = '' ): LMAT_Language {
		/** @var LMAT_Language $default_language The default language is always defined. */
