...
if ( ! class_exists( 'Linguator\Settings\Header\Header' ) ) {
	...
	class Header {
		...
		public function header() {
			...
			echo '<a href="https://linguator.com/video-tutorials/?utm_source=lmat_plugin&utm_medium=inside&utm_campaign=video&utm_content=dashboard" target="_blank" class="lmat-header-action-link">' . esc_html__( 'Video Tutorial', 'linguator-multilingual-ai-translation' ) . '</a>';
