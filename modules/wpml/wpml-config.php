 ...
 * @phpstan-type BlockEncoding array<non-falsy-string, non-falsy-string>
 */
class LMAT_WPML_Config
{
	...
	public function init()
	{
		...
		add_filter('lmat_block_attribute_encodings', array($this, 'decode_blocks_attributes'), 20);
	...
	private function get_plugin_files()
	{
		...
		if (is_multisite()) {
			// Don't forget sitewide active plugins
